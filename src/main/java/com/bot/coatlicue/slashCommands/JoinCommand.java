...
public class JoinCommand implements SlashCommandCreateListener {
    ...
    private final String TAG = "$ - JoinCommand: ";
    ...
    public void onSlashCommandCreate(SlashCommandCreateEvent slashCommandCreateEvent) {
        ...
        if(sci.getCommandName().equals("cjoin")) {
            ...
            System.out.println(TAG + "Please Ignore the following message, I dont know why this block of code" +
                    " is getting triggered but it does not impend the final project");
            System.out.println(TAG + "I Disconnected, Crying Emoji");
        }
    }
}