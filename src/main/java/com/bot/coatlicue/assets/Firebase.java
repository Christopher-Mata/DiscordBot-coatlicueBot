...
public class Firebase {
    ...
    public void update(Object value, String key) {
        try {
            ...
            ref.setValue(value, new DatabaseReference.CompletionListener() {
                ...
                public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                    if (databaseError != null) {
                        System.out.println(TAG + "Data could not be saved " + databaseError.getMessage());
                        latch.countDown();
                    } else {
                        System.out.println(TAG + "Data saved successfully.");
                        latch.countDown();
                    }
                }
            });
            ...
            System.out.println(TAG + "The was a problem accessing the DB!");
            e.printStackTrace();
        }
    }
